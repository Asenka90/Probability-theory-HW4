...
print("В университет на факультеты A и B поступило равное количество\
студентов, а на факультет C студентов поступило столько же, сколько на A и B вместе. \
...
first_athlete = probadility_of_each(1, 4, 0.8)
print(f"First athlete: {first_athlete:.9f}")

second_athlete = probadility_of_each(1, 4, 0.7)
print(f"Second athlete: {second_athlete:.9f}")

third_athlete = probadility_of_each(1, 2, 0.9)
